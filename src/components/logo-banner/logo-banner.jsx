...
export const LogoBanner = () => {
  return (
    ...
    <div className="mx-auto container px-6">
      <h2 className="text-center text-2xl text-purple font-semibold leading-8 text-gray-900">
        Trusted By Over 13,400 Great Teams
      </h2>
      <p className="text-center text-grey text-base pt-10">Leading Companies Use The Same Courses To Help Employees Keep Their Skills Fresh.</p>
