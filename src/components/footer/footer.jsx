    ...
    <>
      <div className="bg-white text-center grid lg:grid-cols-4 md:grid-cols-2 md:text-start my-20 container mx-auto ">
        <div>
          ...
          <ul className="flex text-grey gap-5 mt-5 text-lg md:justify-start justify-center">
        ...
        <div>
          <ul className="text-grey flex flex-col gap-3 leading-7 mt-7">
            <li className="text-purple font-semibold text-xl pb-3">Resource</li>
        ...
        <div>
          <ul className="text-grey flex flex-col gap-3 leading-7 mt-7">
            <li className="text-purple font-semibold text-xl pb-3">Courses</li>
